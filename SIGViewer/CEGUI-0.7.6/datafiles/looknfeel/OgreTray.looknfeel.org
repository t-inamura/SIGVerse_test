...
:::: Titlebar
-->
    <WidgetLook name="OgreTray/TitlebarSubView">
...
<!--
:::: Frame Window for SubView on SIGViewer
-->
    <WidgetLook name="OgreTray/FrameWindowSubView">
        ...
        <Child type="OgreTray/TitlebarSubView" nameSuffix="__auto_titlebar__">
            <Area>
                <Dim type="LeftEdge" >
                    <ImageDim imageset="OgreTrayImages" image="TrayL" dimension="Width">
                        <DimOperator op="Divide">
